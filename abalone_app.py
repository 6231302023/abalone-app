...
v_Whole_weight = st.sidebar.slider('Whole_weight', min_value=0.0, max_value=3.0, value=0.8)
v_Shucked_weight = st.sidebar.slider('Shucked_weight', min_value=0.0, max_value=2.0, value=0.3)
